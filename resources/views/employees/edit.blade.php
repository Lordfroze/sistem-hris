        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('employees.update', $employee->id)}}" method="post">
                    ...
                    <div class="mb-3">
                        <!-- department id dari relasi table employees dengan table department -->
                        <label for="" class="form-label">Department</label>
                        <select name="department_id" id="department_id" class="form-control @error('department_id') is-invalid @enderror">
                            <option value="">Select Department</option>
                            @foreach($departments as $department)
                            <!-- jika department id sama dengan department id employee, maka pilih department tersebut -->
                    ...
                    <div class="mb-3">
                        <!-- role id dari relasi table employees dengan table role -->
                        <label for="" class="form-label">Role</label>
                        <select name="role_id" id="role_id" class="form-control @error('role_id') is-invalid @enderror">
                            <option value="">Select Role</option>
                            @foreach($roles as $role)
                            <!-- jika role id sama dengan role id employee, maka pilih role tersebut -->
