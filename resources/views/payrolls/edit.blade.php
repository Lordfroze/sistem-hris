        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('payrolls.update', $payroll)}}" method="post">
                    ...
                    <!-- disable karena net_salary otomatis dari salary, deductions dan bonuses dari controller -->
                    <div class="mb-3">
                        <label for="" class="form-label">Net Salary</label>
                        <input type="number" class="form-control" name="net_salary" disabled required>
                        @error('net_salary')
                        <div class="invalid-feedback">{{message}}</div>
                        @enderror
                    </div>
